...
const conferenceKnockoutSchema = z.object({
    ...
    rounds: z.array(z.object({
        ...
        ties: z.array(z.object({
            ...
            goalsForA: z.number().int().nonnegative().optional(),
            goalsForB: z.number().int().nonnegative().optional(),
            goalDifferenceA: z.number().int().optional(),
            goalDifferenceB: z.number().int().optional(),
            cleanSheetsA: z.number().int().min(0).max(2).optional(),
            cleanSheetsB: z.number().int().min(0).max(2).optional(),
